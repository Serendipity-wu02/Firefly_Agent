...
let sendToLive2DWindow: (channel: string, payload?: unknown) => boolean = () => false;
...
toolRegistry.register(createPlayLive2DActionTool({ sendToLive2DWindow: (channel, payload) => sendToLive2DWindow(channel, payload) }));
