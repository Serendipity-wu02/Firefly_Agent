...
export const VAULT_README_MD = `# Firefly Learn Workspace

This is your **Firefly Learn workspace**. Firefly will help you read materials, take notes, create exercises, track progress, and review what you have learned.
...
| \`notes/\` | Learning notes maintained by you and Firefly. |
| \`exercises/\` | Exercises, quizzes, mistakes and review notes. |
| \`templates/\` | Reusable templates for notes and reviews. |
| \`learn/progress.md\` | Overall learning progress, maintained by Firefly. |
...
2. Tell Firefly: "I want to learn this."
3. Firefly will read the material, discuss it with you, and offer to take notes in \`notes/\`.
4. After a learning session, Firefly will update \`learn/progress.md\` silently.

> Do not manually edit \`learn/progress.md\` unless you know what you are doing. Firefly keeps it up to date after each session.
`;
...
Firefly reads files in this directory when you ask about them. By default she does **not** modify files here, so your originals stay intact.
...
This is where Firefly writes learning notes for you, and where you can write your own notes too.
...
- Add tags like ` + "`#concept`" + ` or ` + "`#paper`" + ` so Firefly can find them later.
`;
...
- Mark questions you still find difficult so Firefly can revisit them.
`;
