...
export const fireflyMomentsPostingEnabledInput = document.getElementById("firefly-moments-posting-enabled") as HTMLInputElement;
export const fireflyMomentsReactionsEnabledInput = document.getElementById("firefly-moments-reactions-enabled") as HTMLInputElement;
