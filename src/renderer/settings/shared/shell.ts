...
export const fireflyPanel = document.getElementById("firefly-panel") as HTMLFormElement;
...
export const fireflySaveStatus = document.getElementById("firefly-save-status") as HTMLElement;
