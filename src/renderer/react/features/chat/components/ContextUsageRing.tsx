...
/** 三档文字提示按调用时求值，随语言切换更新。 */
export function contextUsageMoodMeta(): Record<ContextUsageRingTone, { text: string }> {
  return {
    normal: { text: t("contextRing.moodNormal") },
    warm: { text: t("contextRing.moodWarm") },
    alert: { text: t("contextRing.moodAlert") },
  };
}
