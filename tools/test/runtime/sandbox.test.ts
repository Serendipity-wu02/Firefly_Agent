...
const workspaceProfile: SandboxProfile = {
  id: profileId,
  version: "1.0.0",
  rules: [
    {
...
function makeInput(
  ...
  requester: CapabilityRequester = { type: "main-agent", id: "firefly-main" },
...
test("F-G. Requester and capability identity cross the boundary as metadata", () => {
  const evaluator = new SandboxPolicyEvaluator([workspaceProfile]);
  const requesters: CapabilityRequester[] = [
    { type: "main-agent", id: "firefly-main" },
    { type: "subagent", id: "future-subagent", subAgentId: createSubAgentId("future-subagent"), taskId: createSubAgentTaskId("future-task"), parentRunId: "run-1" },
