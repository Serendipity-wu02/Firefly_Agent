...
import {
  SubAgentRegistry,
} from "../../../dist/main/main/orchestrator/subagents/subagent-registry.js";
import {
  SubAgentServiceError,
} from "../../../dist/main/main/orchestrator/subagents/subagent-errors.js";
import {
  SubAgentTaskService,
} from "../../../dist/main/main/orchestrator/subagents/subagent-task-service.js";
...
const subagentDirectory = path.join(projectRoot, "src", "main", "orchestrator", "subagents");
const subAgentId = createSubAgentId("synthetic.worker");
const otherSubAgentId = createSubAgentId("synthetic.other");
const capabilityId: CapabilityId = createCapabilityId("synthetic.read");

function createDescriptor(id: SubAgentDescriptor["id"] = subAgentId): SubAgentDescriptor {
  return {
    id,
...
function createConstraints(overrides: Partial<SubAgentTaskConstraints> = {}): SubAgentTaskConstraints {
  return {
    maxSteps: 4,
    maxToolCalls: 3,
    timeoutMs: 10_000,
...
function createRootInput(overrides: Partial<SubAgentTaskInput> = {}): SubAgentTaskInput {
  return {
    subAgentId,
